...
export default function GamePage() {
  ...
  const leftimg = `../../img/gameImg/${
    gameData.data[0].leftId == null ? 2 : gameData.data[0].leftId
  }.jpg`;
  const rightimg = `../../img/gameImg/${
    gameData.data[0].rightId == null ? 2 : gameData.data[0].rightId
  }.jpg`;
  const GameID =
    gameData.data[1]?.gameId === null ? "1" : gameData.data[1]?.gameId;
      ...
      <div>
        {id >= 32 ? (
          <g.balanceButtonWrapFinal>
            <g.balanceButtonFinal>결과페이지 보러가기</g.balanceButtonFinal>
          </g.balanceButtonWrapFinal>
        ) : (
          <div>
            <g.balanceButtonWrap>
            ...
            <g.balanceTextWrap>
              <g.balanceText onClick={leftGo}>
                {gameData.data[0].leftAnswer}
              </g.balanceText>
              <g.balanceText onClick={rightGo}>
                {gameData.data[0].rightAnswer}
              </g.balanceText>
            </g.balanceTextWrap>
            <g.firstWrap>
