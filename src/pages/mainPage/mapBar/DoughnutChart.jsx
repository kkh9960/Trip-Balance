...
export default function DoughnutChart() {
  // const seoulData = useSelector((state) => state.MapSlice.data?.cnt);
      ...
      datasets: [
        {
          label: "# of Votes",
          data: [
            peopleData[2]?.peopleCnt,
            peopleData[3]?.peopleCnt,
            peopleData[4]?.peopleCnt,
            peopleData[5]?.peopleCnt,
            peopleData[6]?.peopleCnt,
            peopleData[7]?.peopleCnt,
          ],
          backgroundColor: [
            "rgba(54, 162, 235, 0.7)",
            "rgba(255, 206, 86, 0.7)",
